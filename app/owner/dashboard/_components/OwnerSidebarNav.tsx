...
const navItems = [
  ...
  {
    label: "Mes paiements",
    href: "/owner/dashboard/paiements",
    icon: (
      <svg className="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
...
export default function OwnerSidebarNav({
  ...
  return (
    <nav className="space-y-0.5">
      ...
      {navItems.map((item) => {
        ...
        return (
          <Link
            ...
            style={{
              backgroundColor: isActive ? "rgba(200,146,42,0.15)" : "transparent",
              color: isActive ? "#C8922A" : "rgba(255,255,255,0.6)",
          ...
          >
            <span
              ...
              style={{ color: isActive ? "#C8922A" : "rgba(255,255,255,0.45)" }}
            >
              {item.icon}
      ...
      {/* Séparateur + lien retour au site */}
