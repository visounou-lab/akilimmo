              ...
              {[
                {
                  ...
                  desc: "Collecte automatique des paiements de vos locataires",
                },
                {
                  icon: "📞",
                  title: "Relances locataires",
                  desc: "Suivi des paiements et relances en cas de retard",
                },
                {
                  icon: "🔍",
                  title: "État des lieux",
                  desc: "Expertise de l'état des biens à l'entrée et sortie",
                },
                {
                  icon: "👥",
                  title: "Recherche de locataires",
                  desc: "Sélection rigoureuse de locataires sérieux et solvables",
                },
                {
                  icon: "📊",
                  title: "Rapports mensuels",
                  desc: "Synthèse détaillée de vos revenus et dépenses",
                },
                {
                  icon: "🌍",
                  title: "Gérez de partout",
                  desc: "Depuis la France, Belgique, Canada ou n'importe où",
                },
              ].map((item, i) => (
                <motion.div
                  key={i}
      ...
      <section className="py-20 bg-[#F8FAFC]">
        <div className="mx-auto max-w-4xl px-6 lg:px-8">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                "Propriétaires résidant en France",
                "Propriétaires en Belgique",
                "Propriétaires au Canada",
                "Propriétaires expatriés partout dans le monde",
                "Ayant des biens au Bénin",
                "Ayant des biens en Côte d'Ivoire",
              ].map((item, i) => (
                <motion.div
                  key={i}
                  initial="hidden"
      ...
      <section className="py-20 bg-white">
        <div className="mx-auto max-w-4xl px-6 lg:px-8">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-3xl font-bold text-slate-900 mb-8">Les avantages</h2>
            <div className="space-y-4">
              {[
                "✓ Gérez votre patrimoine depuis la France, la Belgique, le Canada ou n'importe où",
                "✓ Zéro stress avec les retards de paiement",
                "✓ Revenus sécurisés et impayés gérés",
                "✓ Rapports détaillés à chaque clôture mensuelle",
                "✓ Experts locaux pour l'inspection et les relances",
              ].map((item, i) => (
                <motion.div
                  key={i}
                  initial="hidden"
                  ...
                  variants={fadeInUp}
                  transition={{ duration: 0.6, delay: i * 0.1 }}
                  className="text-lg text-slate-700 p-4 rounded-lg bg-slate-50 border border-slate-100"
                >
                  {item}
                </motion.div>
              ))}
      ...
      <section className="py-20 bg-[#F8FAFC]">
        <div className="mx-auto max-w-4xl px-6 lg:px-8">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <a
                href="https://wa.me/2290197598682?text=Bonjour AKIL IMMO, je suis intéressé par votre service de gestion locative au Bénin"
                target="_blank"
              ...
              <a
                href="https://wa.me/2250710259146?text=Bonjour AKIL IMMO, je suis intéressé par votre service de gestion locative en Côte d'Ivoire"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 rounded-2xl bg-green-500 hover:bg-green-600 px-6 py-4 text-lg font-semibold text-white transition shadow-lg"
              >
