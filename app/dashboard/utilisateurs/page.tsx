        ...
        <div>
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            ...
            <form action={createUser} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-[#1C1917] hover:bg-[#2D2420] text-white text-sm font-semibold transition-colors shadow-sm"
              >
