        ...
        <div className="flex items-center gap-3">
          ...
          {isBienDetail && (
            <button
              ...
              className="hidden md:inline-flex items-center gap-2 rounded-full bg-[#00D4F0] hover:bg-[#00bcd4] px-5 py-2.5 text-sm font-semibold text-white shadow-lg transition-all duration-200 hover:scale-105 animate-pulse-soft"
            >
